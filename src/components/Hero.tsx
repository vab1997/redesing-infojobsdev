    ...
    <div className='max-w-6xl w-full py-24'>
      <div className='flex items-center justify-between w-full'>
        <div className='flex flex-col gap-4 w-[600px]'>
          ...
          <div className='flex items-center justify-center gap-4 bg-[#282A36] rounded py-8 px-6 border border-[#EE81C3]'>
            <button className='px-4 py-2 rounded text-white bg-zinc-400/5 hover:bg-white/10 transition border-white/10'>
              Job search
            </button>
            <button className='px-4 py-2 rounded text-white bg-zinc-400/5 hover:bg-white/10 transition border-white/10'>
        ...
        <div className='flex items-center justify-center max-w-[400px] w-full'>
          <div className='flex flex-col gap-2'>
            <a
              href='/'
              className='flex justify-center flex-col gap-1 px-4 py-2 rounded text-white bg-zinc-400/5 hover:bg-white/10 transition border-white/10'
            >
            ...
            <a
              href='/'
              className='flex items-center bg-transparent text-lg text-[#EE81C3] hover:opacity-90'
            >
              or{' '}
